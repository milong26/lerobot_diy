...
# baseline的测试
# raise KeyError("没改")
output_directory = Path("for_pusht/output_scaled/output_just/relative") 
# relative的测试
...
# raise KeyError("没改")
pretrained_policy_path = Path("for_pusht/train_just_0915/mtask_scaled_relative/checkpoints/026000/pretrained_model")
