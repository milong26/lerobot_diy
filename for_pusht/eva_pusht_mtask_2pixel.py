...
# baseline的测试
# raise KeyError("没改")
output_directory = Path("for_pusht/mytrain_result_final_just/2pixel") 
# relative的测试
...
# raise KeyError("没改")
pretrained_policy_path = Path("for_pusht/train_just/mtask_2pixel/checkpoints/026000/pretrained_model")
...
#===========================================
obj_detector= VisionProcessor(language_tip_mode="2pixel")
