...
# baseline的测试
# raise KeyError("没改")
output_directory = Path("for_pusht/mytrain_result_final/30pixel") 
# relative的测试
...
# raise KeyError("没改")
pretrained_policy_path = Path("for_pusht/train/mtask_30pixel/checkpoints/026000/pretrained_model")
