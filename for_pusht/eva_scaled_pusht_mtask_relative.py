...
# baseline的测试
raise KeyError("没改")
output_directory = Path("for_pusht/output_scaled/relative") 
# relative的测试
...
raise KeyError("没改")
pretrained_policy_path = Path("for_pusht/output_just_scaled/mtask_2pixel/checkpoints/026000/pretrained_model")
